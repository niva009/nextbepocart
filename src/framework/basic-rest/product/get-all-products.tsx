...
const fetchProducts = async ({ queryKey }: any) => {
  ...
  let url = `https://patrick-north-power-fence.trycloudflare.com/subcategory/${category}/`;
  ...
  try {
    ...
    url = `https://patrick-north-power-fence.trycloudflare.com/category/${category}/products/`;
